...
//maximum gnss number in one gnss-imu factor
#define GNSS_MAX_NUM_ONE_FACTOR 30
//maximum number of gnss frames
#define GNSS_WINDOW_SIZE GNSS_MAX_NUM_ONE_FACTOR*FEATURE_WINDOW_SIZE
...
//enable gpu for feature extraction
#define USE_CUDA 1
...
//inform the real time status if set this to true
#define ENABLE_ONLINE 1
//eps for peudo inverse
#define EPSS 1e-8
//feature weight
#define SQRT_INFO_FEATURE  FOCAL_LENGTH / FEATUREWEIGHTINVERSE
//cpu set for sliding window filter optimization.
#define  SWF_CPU_SET {0, 3, 4, 5}
//cput set for main process, the size should be 1.
#define   MAIN_CPU_SET {2}
...
extern std::vector<Eigen::Quaterniond> QCI;
//rotation from camera to imu
extern std::vector<Eigen::Matrix3d> RIC;
//translation from camera to imu
extern std::vector<Eigen::Vector3d> TIC;

extern std::vector<Eigen::Vector3d> Pcg;
//gravity vector
